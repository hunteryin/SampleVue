  ...
  <div class="Advertise-Detail-BigBox Box-Below-Header">
    ...
    <div v-if="advertise.Address">
      <a class="mint-cell" :href="mapurl + taddress">
        <div v-if="advertise.Address.length >33">
...
<script>  
  ...
  export default {
    ...
    created() {  
      ...
      this.topath = this.$route.query.topath?this.$route.query.topath:"/"  
      ...
      axios.get(this.host + 'api/GetAdvertiseByID/' + this.$route.query.id)
      .then(response => {                                    
        ...
        this.wechaturl= this.webhost + "AdvertiseDetail?id=" + this.$route.query.id 
        this.title =  "犹他家园: " + this.advertise.ShopName  	     
